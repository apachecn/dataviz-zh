...
> 原文： [https://serialmentor.com/dataviz/technical-notes.html](https://serialmentor.com/dataviz/technical-notes.html)

整本书是用 R Markdown 编写的，使用 **bookdown** ， **rmarkdown** 和 **knitr** 软件包。所有数据均使用 **ggplot2** ，附加包装 **cowplot** ，**蛋**， **ggforce** ， **ggrepel [** ， **ggridges** ， **sf** 和 **treemapify** 。使用**颜色空间**和 **colorblindr** 包进行颜色处理。对于其中许多软件包，需要当前的开发版本来编译本书的所有部分。

这本书的源代码可以在这里找到： [https://github.com/clauswilke/dataviz](https://github.com/clauswilke/dataviz) 。该书还需要一个支持 R 包， **dviz.supp** ，其代码可在此处获取： [https://github.com/clauswilke/dviz.supp](https://github.com/clauswilke/dviz.supp) 。
